...
insert into opcoes_sistema (categoria, valor, ordem) values
  ...
  -- Categorias financeiras — A Pagar
  ('categorias_financeiro_pagar', 'Aluguel', 0),
  ('categorias_financeiro_pagar', 'Água', 1),
  ('categorias_financeiro_pagar', 'Luz', 2),
  ('categorias_financeiro_pagar', 'Internet', 3),
  ('categorias_financeiro_pagar', 'Material Escolar', 4),
  ('categorias_financeiro_pagar', 'Alimentação', 5),
  ('categorias_financeiro_pagar', 'Transporte', 6),
  ('categorias_financeiro_pagar', 'Salários', 7),
  ('categorias_financeiro_pagar', 'Impostos', 8),
  ('categorias_financeiro_pagar', 'Outros', 9),
  -- Categorias financeiras — A Receber
  ('categorias_financeiro_receber', 'Doações', 0),
  ('categorias_financeiro_receber', 'Mensalidades', 1),
  ('categorias_financeiro_receber', 'Arrecadação', 2),
  ('categorias_financeiro_receber', 'Eventos', 3),
  ('categorias_financeiro_receber', 'Patrocínios', 4),
  ('categorias_financeiro_receber', 'Subvenções', 5),
  ('categorias_financeiro_receber', 'Outros', 6),
  -- Unidades de estoque
